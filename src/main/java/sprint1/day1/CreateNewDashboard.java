...
public class CreateNewDashboard {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //driver.findElement(By.xpath("//input[contains(@placeholder,'Search apps or items')]")).sendKeys("Dashboards");

        //driver.findElement(By.xpath("//span[@title = 'All Items']/following::mark[text()='Dashboards']")).click();
